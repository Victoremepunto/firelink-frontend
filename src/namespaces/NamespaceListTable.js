        ...
        <Tbody key="tbody">
            ...
            {filteredNamespaces.map(namespace => <Tr key={namespace.namespace}>
                ...
                <Td textCenter dataLabel={columnNames.cpu}>
                    <ResourceUsageProgress namespace={namespace.namespace} resource="cpu"/>
                </Td>
                <Td textCenter dataLabel={columnNames.memory}>
                    <ResourceUsageProgress namespace={namespace.namespace} resource="memory"/>
                </Td>
                <Td textCenter dataLabel={columnNames.requester} style={{maxWidth: "10rem"}}>
                    <Tooltip content={namespace.requester}>
                        <Truncate content={namespace.requester}  trailingNumChars={10}/>
                    </Tooltip>
                </Td>
